  ...
  return (
    <div className="bg-darkGray rounded-lg p-10 text-center">
      ...
      <div className="flex justify-center space-x-2">
        <input
          type="text"
          className="bg-blueish rounded-md py-1.5 px-2 w-2/4 text-white placeholder-gray focus:outline-none "
          placeholder="example@gmail.com"
        />
        <button className="bg-white text-black text-sm px-3 rounded-md">
          Sign up
        </button>
      </div>
    </div>
